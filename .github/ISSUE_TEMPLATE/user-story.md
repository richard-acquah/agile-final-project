 ...
 **So that** I can make it available for customers to view.
 ...
 ### Acceptance Criteria   
 gherkin\
 Given I craete new product catalog \
 ...
 **So that** I can view its details.
 ...
 ### Acceptance Criteria  
 gherkin\
 Given i want view details of a product\
 When i retrieve the product fron the product catalog\
 ...
 **So that** I can add new description and product image of the product.
 ...
 ### Acceptance Criteria  
 gherkin\
 Given i want update the product acatalog\
 ...
 **So that** outdated items are removed from the catalog.
 ...
 ### Acceptance Criteria  
 gherkin\
 Given I need some product out the catalog\
 ...
 **So that** I can efficiently find what I need. and can afford
 ...
 **So that** it is scalable to meet users demand, secure to reduce cyberthreats, and always available.
 ...
 ### Acceptance Criteria  
 gherkin\
 Given there is outage in the companies premise \
 When i access the e-commence websitet \
 ...
 **So that** releases are consistent and repeatable.
 ...
 ### Acceptance Criteria  
 gherkin\
 Given i want my code deployed in the cloud\
 When i deploy new changes to the cloud\
 Then it should consistent automatic deployment 
